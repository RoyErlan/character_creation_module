...
def attack(char_name: str, char_class: str) -> str:
    """Описание атаки для каждого персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Описание блокировки для каждого персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Описание специального умения для каждого персонажа."""
    if char_class == 'warrior':
        return (f'{char_name} '
...
def choice_char_class() -> str:
    """Функция ввода в игру, выбор персонажа."""
    approve_choice: str = ''
    char_class: str = ''
